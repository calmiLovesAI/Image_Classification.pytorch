...
class MobileNetV2Pretrained(MobileNetV2):
    ...
    def __init__(self, cfg):
        ...
        if pretrained:
            # 加载预训练模型
            state_dict = load_state_dict_from_url(url=MobileNet_Weights.mobilenet_v2_weights_url,
                                                  model_dir="web/mobilenet_v2_ImageNet1K.pth",
                                                  map_location=device)
